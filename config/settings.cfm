...
<cfset set(functionName="textField", labelPlacement="before", prependToLabel="<div><strong>", append="</strong></div>", appendToLabel="<br/>")/>
<cfset set(functionName="passwordField", labelPlacement="before", prependToLabel="<div></strong>", append="</strong></div>", appendToLabel="<br/>")/>
...
<cfset set(functionName="select", labelPlacement="before", prependToLabel="<div><strong>", append="</strong></div>", appendToLabel="<br/>")/>
<cfset set(functionName="textarea", labelPlacement="before", prependToLabel="<div><strong>", append="</div>", appendToLabel="</strong><br/>")/>